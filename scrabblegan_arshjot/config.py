...
class Config:
    ...
    grad_alpha = 1
    grad_balance = True
    data_file = r'/home/mgl/Bureau/Travail/projets/Front_Justice/scripts_divers/ScrabbleGAN/synthetic_small_corpus_64px/finetuned/custom_data.pkl'
    ...
    z_dim = 128
    num_chars = 93
    weight_dir = r'/home/mgl/Bureau/Travail/projets/Front_Justice/scripts_divers/ScrabbleGAN/synthetic_small_corpus_64px/finetuned'
